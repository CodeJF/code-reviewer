"""
Read-only Elasticsearch access for the IoT Ops Agent.

The ES cluster is reached through the configured SSH gateway and queried on
its loopback address. This keeps the logging system private while giving local
...
from iot_ops_agent.config import get_es_config
