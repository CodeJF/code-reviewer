...
from team_app.auth import MemorySecurityStore, RedisSecurityStore, SecurityStore, source_hash, token_hash
from team_app.config import TeamSettings
from team_app.db import initialize_database, make_session_factory, migration_is_current
...
def create_app(
    ...
    *,
    ...
    app = FastAPI(title="SL100 团队值班工作台", version="2.0.0", lifespan=lifespan)
    ...
    def enforce_diagnosis_limits(session: Session, user: User) -> None:
