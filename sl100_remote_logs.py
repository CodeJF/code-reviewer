...
Examples:
  ...
  uv run sl100_remote_logs.py search --service pushService --log stderr --keyword panic
  uv run sl100_remote_logs.py analyze --service AdminService --logs error,stderr
"""
